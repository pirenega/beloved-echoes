...
const translations: Record<Language, Record<string, string>> = {
  ...
  it: {
	...
	'story.3.content': 'Keri era la gatta di Eli. Eli l\'aveva persino addestrata a spaventarsi ogni volta che sentiva la minaccia: «Ti farò diventare un colletto!». Bastava sentire quelle parole e Keri drizzava le orecchie, diventando immediatamente sospettosamente obbediente. Keri viveva con Eli e sua madre fin dal 1992. A quel tempo i genitori di Eli erano già divorziati e vivevano da sole. Poi, nel 1997, Irena partì per l\'Italia per studiare con suo padre. Prima di allora, però, Keri era una vera combinaguai. Aveva imparato ad aprire il frigorifero e controllava regolarmente cosa ci fosse dentro. Altre volte sparpagliava palline di carta igienica sul tappeto marrone e poi saltava e si tuffava su di esse con grande entusiasmo, come se stesse cacciando una preda. Nemmeno la poltrona verde di gommapiuma fu risparmiata: Keri vi affilava gli artigli finché non l\'aveva ridotta a frange. Ciò che spaventava di più Eli, però, era quando catturava i piccioni dal balcone del nono piano. A volte poi trovavano i poveri uccelli sotto la poltrona. A dire il vero, la madre di Eli considerava perfettamente normale che una gatta cacciasse. Inoltre erano anni difficili. Così Keri rimase allo stesso tempo una compagna amata, una cacciatrice e la più grande combinaguai della casa. E la frase «Ti farò diventare un colletto!» era una delle poche cose che riuscivano a farla rigare dritto, almeno per un po’.',
