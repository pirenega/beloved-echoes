...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'spiritual.scalarWaves': 'Scalar Waves',
	...
	'story.2.title': 'Chicken Lyoncho...',
	'story.2.content': 'When Eli was little, she became fond of one of the chicks while it was still very small and named him Lyoncho. He was tiny, yellow, fluffy, and followed Eli everywhere. As time passed, Lyoncho grew, and Eli loved him very much. But around Christmas, Lyoncho disappeared. Eli searched for him everywhere, but he was nowhere to be found. Finally, she asked where he was and received the answer: "Where else would he be, Lenche? We slaughtered him!". Eli was very saddened. From then on, she always remembered her beloved chick Lyoncho with affection.',
	'story.3.title': 'Keri the Cat! KK',
	'story.3.content': 'Keri was Eli’s cat. Eli had even trained her to get startled whenever she heard the warning: “I’ll turn you into a fur collar!”. As soon as Keri heard those words, she would perk up her ears and suddenly become suspiciously well-behaved. Keri lived with Eli and Irka from 1992 onwards. At that time Eli and Vlado were already divorced and Eli and Irka lived alone together. Later, in 1997, Irka moved to Italy to study with her father. Before that, however, Keri was a true little troublemaker. She had learned how to open the refrigerator and regularly checked what was inside. At other times she would shred toilet paper into little balls all over the brown carpet and then happily jump and pounce on them as if she were hunting prey. The green foam armchair did not escape her either. Keri sharpened her claws on it until it was reduced to hanging strips. What frightened Irka the most, though, was when Keri caught pigeons from the ninth-floor balcony. Sometimes the poor birds would later be found under the armchair. To be fair, Eli considered it perfectly normal for a cat to hunt. Those were difficult years as well. So Keri remained at the same time a beloved companion, a hunter, and the chief troublemaker of the household. And the phrase “I’ll turn you into a fur collar!” was one of the few things that could make her behave, at least for a little while.',
  ...
  it: {
    ...
    'spiritual.scalarWaves': 'Onde Scalari',
	...
	'story.2.title': 'Il pulcino Leoncho...',
	'story.2.content': 'Quando Eli era piccola, si affezionò a uno dei pulcini quando era ancora piccolissimo e lo chiamò Leoncho. Era giallo, soffice e la seguiva ovunque. Con il tempo il pulcino Leoncho crebbe e Eli gli voleva molto bene. Ma, verso Natale, Leoncho scomparve. Eli lo cercò dappertutto, ma non riusciva a trovarlo. Alla fine chiese dove fosse e ricevette questa risposta: «E dove vuoi che sia, Lenche? L’abbiamo macellato!». Eli rimase molto triste. Da allora ricordò sempre con affetto il suo amato pulcino Leoncho.',
	'story.3.title': 'Keri la Gatta! KK',
	'story.3.content': 'Keri era la gatta di Eli. Eli l\'aveva persino addestrata a spaventarsi ogni volta che sentiva la minaccia: «Ti farò diventare un colletto!». Bastava sentire quelle parole e Keri drizzava le orecchie, diventando immediatamente sospettosamente obbediente. Keri viveva con Eli e Irka fin dal 1992. A quel tempo Eli e Vlado  erano già divorziati ed Eli e Irka vivevano da sole. Poi, nel 1997, Irka partì per l\'Italia per studiare con suo padre. Prima di allora, però, Keri era una vera combinaguai. Aveva imparato ad aprire il frigorifero e controllava regolarmente cosa ci fosse dentro. Altre volte sparpagliava palline di carta igienica sul tappeto marrone e poi saltava e si tuffava su di esse con grande entusiasmo, come se stesse cacciando una preda. Nemmeno la poltrona verde di gommapiuma fu risparmiata: Keri vi affilava gli artigli finché non l\'aveva ridotta a frange. Ciò che spaventava di più Irka, però, era quando catturava i piccioni dal balcone del nono piano. A volte poi trovavano i poveri uccelli sotto la poltrona. A dire il vero, Eli considerava perfettamente normale che una gatta cacciasse. Inoltre erano anni difficili. Così Keri rimase allo stesso tempo una compagna amata, una cacciatrice e la più grande combinaguai della casa. E la frase «Ti farò diventare un colletto!» era una delle poche cose che riuscivano a farla rigare dritto, almeno per un po’.',
  ...
  bg: {
    ...
    'spiritual.scalarWaves': 'Скаларни Вълни',
	...
	'story.2.title': 'Пилето Льончо...',
	'story.2.content': 'Когато Ели била малка, си харесала едно от пиленцата още съвсем мъничко и го кръстила Льончо. То било малко, жълто и пухкаво и навсякъде следвало Ели. Пиленцето Льончо започнало да расте, а Ели много си го обичала. Но около Коледа Льончо изчезнало. Ели го търсила навсякъде, но никакво го нямало. Накрая попитала къде е и получила отговора: „Ами къде да е, бе, Ленче? Заклахме го!“. Ели останала много натъжена. Оттогава винаги си спомняла за своето любимо пиленце Льончо.',
	'story.3.title': 'Кери Котка! КК',
	'story.3.content': 'Кери беше котката на Ели. Ели дори я беше дресирала да се стряска всеки път, когато чуеше заканата: „На яка ще те направя!“. Само да чуеше тези думи, Кери наостряше уши и веднага ставаше подозрително послушна. Кери живееше с Ели и Ирка още от 1992 година. По онова време Ели и Владо вече бяха разведени и Ирка и Ели живееха сами. После, през 1997 година, Ирка заминала за Италия при баща си, за да учи. Но преди това Кери била истинска майсторка на белите. Беше се научила да отваря хладилника и редовно проверяваше какво има вътре. Друг път разпердушинваше топчета от тоалетна хартия по кафявия мокет и после с огромно удоволствие подскачаше и се хвърляше върху тях, сякаш ловеше дивеч. Зеленото дунапренено кресло също не беше пощадено. Кери си остреше ноктите върху него, докато накрая го беше превърнала в ресни. Най-много обаче плашеше Ирка, когато хващаше гълъби от балкона на деветия етаж. Понякога после намираха горките птици под креслото. В интерес на истината, Ели смяташе за съвсем нормално едно коте да ловува. А и това бяха трудни години. Така Кери си остана едновременно любимец, ловец и главен пакостник в дома им. А фразата „На яка ще те направя!“ беше едно от малкото неща, които успяваха поне за малко да я вразумят.',
